...
function loadPlaces(map) {
  var lat = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 43.25;
  var lng = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : -79.85;

  _axios2.default.get('/api/stores/near?lat=' + lat + '&lng=' + lng).then(function (res) {
    var places = res.data;
    if (!places.length) {
      (0, _bling.$)('.autocomplete .nothing').innerHTML = 'No places found!';
      return;
    }
    (0, _bling.$)('.autocomplete .nothing').innerHTML = '';
